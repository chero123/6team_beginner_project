# project_ver4/file_py/step01_1_make_dlidx_mapping_ALL.py
import os
import json
import re
...
print(f"[STEP 01-1 ALL] JSON files found: {len(json_paths)}")
...
# DONE
# =========================
print("\n[DONE] STEP 01-1 (ALL CLASSES)")
print(f" - total classes (dl_idx): {len(dlidx_list)}")
